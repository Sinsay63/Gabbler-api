...
public class JwtService
{
    ...
    public static final String SECRET = "38782F413F4428472B4B6250655368566D597133743676397924422645294840";

    private final UserInfosAccessorAdapter userInfosAccessorAdapter;

    public JwtService(UserInfosAccessorAdapter userInfosAccessorAdapter)
    {
